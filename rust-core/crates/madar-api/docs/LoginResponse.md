...
**open_till** | Option<[**models::TillBrief**](TillBrief.md)> | The person's open till at the branch they signed into (any device), so the device can resume it or show where it is open. | [optional]
