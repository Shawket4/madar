...
**require_table_for_orders** | Option<**bool**> | Every dine-in sale belongs to a table. Re-read on every `/auth/me`, so switching it on reaches a till that has been running for weeks. | [optional]
