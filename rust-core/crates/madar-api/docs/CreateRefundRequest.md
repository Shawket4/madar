...
**till_id** | Option<**uuid::Uuid**> | The shift whose drawer the money leaves. Omit for a live request and the actor's own open shift at the order's branch is used; a replayed offline refund must name the shift it was issued in, the way a queued sale does. | [optional]
