...
------------ | ------------- | ------------- | -------------
**effect** | Option<**String**> | `none` | `adds` | `swaps` (default: derived — `swaps` for `milk_type` / `coffee_type`, else `adds`). | [optional]
...
**swap_category_id** | Option<**uuid::Uuid**> | Required meaning for `effect = swaps`: the ingredient category swapped. | [optional]
