...
**gender** | Option<**String**> | `m` · `f`; `null` or empty = not set; omitted keeps what is there. | [optional]
...
**pay_account** | Option<**String**> | The IBAN or wallet number; `null` or empty clears it; omitted keeps it. Always cleared when the method is (or stays) `cash`. | [optional]
**pay_method** | Option<**String**> | `cash` · `bank` · `wallet`; omitted keeps what is there. Cash clears the account. | [optional]
