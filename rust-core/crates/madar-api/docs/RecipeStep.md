...
**name** | **String** | The preset's name, or the typed name of a custom step. | 
**name_ar** | **String** |  | 
**note** | Option<**String**> |  | [optional]
**note_ar** | Option<**String**> |  | [optional]
**position** | **i32** |  | 
**preset_slug** | Option<**String**> | The preset this step uses, if any. | [optional]
