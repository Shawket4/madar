...
**service_charge_waived_count** | Option<**i64**> | Table bills in range whose service charge was waived, and what those charges came to. Additive. | [optional]
**subtotal** | **i64** |  | 
...
**total_service_charge** | Option<**i64**> | Service charge on the dine-in bills in range, less what refunds took back — inside `total_revenue` as the shop's income, not a pass-through. | [optional]
**total_tax** | **i64** |  | 
