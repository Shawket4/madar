...
pub struct StockMovement {
    ...
    #[serde(rename = "branch_stock_id", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl StockMovement {
    pub fn new(balance_after: f64, below_zero: bool, branch_id: uuid::Uuid, created_at: chrono::DateTime<chrono::FixedOffset>, id: uuid::Uuid, ingredient_name: String, movement_type: String, org_ingredient_id: uuid::Uuid, quantity: f64, unit: String) -> StockMovement {
        StockMovement {
            balance_after,
            below_zero,
            branch_id,
