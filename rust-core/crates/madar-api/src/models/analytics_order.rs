...
impl AnalyticsOrder {
    ...
    pub fn new(business_date: chrono::NaiveDate, created_at: chrono::DateTime<chrono::FixedOffset>, discount_amount: i32, order_id: uuid::Uuid, order_number: i32, service_charge: i32, status: String, subtotal: i32, tax_amount: i32, total_amount: i32) -> AnalyticsOrder {
        AnalyticsOrder {
            business_date,
            created_at,
            discount_amount,
