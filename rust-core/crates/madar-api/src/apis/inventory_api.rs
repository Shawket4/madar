...
/// struct for passing parameters to the method [`record_waste`]
#[derive(Clone, Debug)]
pub struct RecordWasteParams {
    pub record_waste_request: models::RecordWasteRequest,
}
...
/// struct for typed errors of method [`record_waste`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RecordWasteError {
    Status400(models::ErrorBody),
    Status401(models::ErrorBody),
    Status403(models::ErrorBody),
    Status404(models::ErrorBody),
...
) -> Result<models::OrgIngredient, Error<CreateCatalogItemError>> {
    let uri_str = format!(
...
pub async fn create_ingredient_category(
    configuration: &configuration::Configuration,
    params: CreateIngredientCategoryParams,
) -> Result<models::IngredientCategory, Error<CreateIngredientCategoryError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/categories",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id)
    );
    let mut req_builder = configuration
...
) -> Result<models::StockTransfer, Error<CreateTransferError>> {
...
pub async fn create_waste(
    configuration: &configuration::Configuration,
    params: CreateWasteParams,
) -> Result<models::StockMovement, Error<CreateWasteError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/waste",
        configuration.base_path,
...
) -> Result<(), Error<DeleteCatalogItemError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/catalog/{id}",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id),
...
) -> Result<(), Error<DeleteIngredientCategoryError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/categories/{id}",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id),
        id = crate::apis::urlencode(params.id)
    );
...
pub async fn delete_transfer(
    configuration: &configuration::Configuration,
    params: DeleteTransferParams,
) -> Result<(), Error<DeleteTransferError>> {
    let uri_str = format!(
...
pub async fn get_inventory_settings(
    configuration: &configuration::Configuration,
    params: GetInventorySettingsParams,
) -> Result<models::OrgInventorySettings, Error<GetInventorySettingsError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/settings",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id)
    );
...
pub async fn list_branch_stock(
    configuration: &configuration::Configuration,
    params: ListBranchStockParams,
) -> Result<Vec<models::BranchStockRow>, Error<ListBranchStockError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/stock",
        configuration.base_path,
        branch_id = crate::apis::urlencode(params.branch_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<Vec<models::OrgIngredient>, Error<ListCatalogError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/catalog",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id)
...
) -> Result<Vec<models::IngredientCategory>, Error<ListIngredientCategoriesError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/categories",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id)
...
) -> Result<Vec<models::StockMovement>, Error<ListMovementsError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/movements",
        configuration.base_path,
        branch_id = crate::apis::urlencode(params.branch_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<Vec<models::StockTransfer>, Error<ListTransfersError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/transfers",
        configuration.base_path,
        branch_id = crate::apis::urlencode(params.branch_id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<Vec<models::StockMovement>, Error<ListWasteError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/waste",
        configuration.base_path,
        branch_id = crate::apis::urlencode(params.branch_id)
...
pub async fn record_waste(
...
) -> Result<models::WasteRecorded, Error<RecordWasteError>> {
    let uri_str = format!("{}/inventory/waste", configuration.base_path);
    let mut req_builder = configuration
        .client
        .request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&params.record_waste_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::WasteRecorded`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::WasteRecorded`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<RecordWasteError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn set_par_levels(
    configuration: &configuration::Configuration,
    params: SetParLevelsParams,
) -> Result<models::BranchStockRow, Error<SetParLevelsError>> {
    let uri_str = format!(
        "{}/inventory/branches/{branch_id}/stock/{org_ingredient_id}/par",
        configuration.base_path,
        branch_id = crate::apis::urlencode(params.branch_id),
        org_ingredient_id = crate::apis::urlencode(params.org_ingredient_id)
    );
...
) -> Result<models::OrgIngredient, Error<UpdateCatalogItemError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/catalog/{id}",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id),
...
pub async fn update_ingredient_category(
    configuration: &configuration::Configuration,
    params: UpdateIngredientCategoryParams,
) -> Result<models::IngredientCategory, Error<UpdateIngredientCategoryError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/categories/{id}",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id),
...
) -> Result<models::OrgInventorySettings, Error<UpdateInventorySettingsError>> {
    let uri_str = format!(
        "{}/inventory/orgs/{org_id}/settings",
        configuration.base_path,
        org_id = crate::apis::urlencode(params.org_id)
...
) -> Result<models::StockTransfer, Error<UpdateTransferError>> {
    let uri_str = format!(
        "{}/inventory/transfers/{id}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
