...
pub async fn loyalty_apple_pass(configuration: &configuration::Configuration, params: LoyaltyApplePassParams) -> Result<(), Error<LoyaltyApplePassError>> {

    let uri_str = format!("{}/public/loyalty/pass/{token}/apple.pkpass", configuration.base_path, token=crate::apis::urlencode(params.token));
...
pub async fn loyalty_card(configuration: &configuration::Configuration, params: LoyaltyCardParams) -> Result<models::CardView, Error<LoyaltyCardError>> {

    let uri_str = format!("{}/public/loyalty/card/{token}", configuration.base_path, token=crate::apis::urlencode(params.token));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn loyalty_card_qr(configuration: &configuration::Configuration, params: LoyaltyCardQrParams) -> Result<(), Error<LoyaltyCardQrError>> {

    let uri_str = format!("{}/public/loyalty/card/{token}/qr.png", configuration.base_path, token=crate::apis::urlencode(params.token));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn loyalty_join(configuration: &configuration::Configuration, params: LoyaltyJoinParams) -> Result<models::JoinResult, Error<LoyaltyJoinError>> {
...
pub async fn loyalty_join_info(configuration: &configuration::Configuration, params: LoyaltyJoinInfoParams) -> Result<models::JoinInfo, Error<LoyaltyJoinInfoError>> {
