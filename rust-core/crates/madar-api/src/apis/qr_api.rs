...
) -> Result<models::QrResponse, Error<BranchBookingQrError>> {
    let uri_str = format!(
        "{}/branches/{id}/booking-qr",
...
) -> Result<models::QrResponse, Error<BranchLoyaltyQrError>> {
    let uri_str = format!(
        "{}/branches/{id}/loyalty-qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<models::QrResponse, Error<BranchQrError>> {
    let uri_str = format!(
        "{}/branches/{id}/qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn create_marketing_link(
    configuration: &configuration::Configuration,
    params: CreateMarketingLinkParams,
) -> Result<models::QrResponse, Error<CreateMarketingLinkError>> {
...
) -> Result<models::BranchTable, Error<CreateTableError>> {
    let uri_str = format!(
        "{}/branches/{id}/tables",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
) -> Result<(), Error<DeleteTableError>> {
    let uri_str = format!(
        "{}/branches/{id}/tables/{tid}",
        configuration.base_path,
        id = crate::apis::urlencode(params.id),
        tid = crate::apis::urlencode(params.tid)
    );
    let mut req_builder = configuration
        .client
...
) -> Result<models::QrResponse, Error<DeliveryOrderQrError>> {
    let uri_str = format!(
        "{}/delivery-orders/{id}/qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
    );
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn list_marketing_links(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::MarketingLink>, Error<ListMarketingLinksError>> {
    let uri_str = format!("{}/qr/links", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<Vec<models::BranchTable>, Error<ListTablesError>> {
    let uri_str = format!(
        "{}/branches/{id}/tables",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
) -> Result<models::QrResponse, Error<OrgBookingQrError>> {
    let uri_str = format!(
        "{}/orgs/{id}/booking-qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
) -> Result<models::QrResponse, Error<OrgLoyaltyQrError>> {
    let uri_str = format!(
        "{}/orgs/{id}/loyalty-qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn org_qr(
    configuration: &configuration::Configuration,
    params: OrgQrParams,
) -> Result<models::QrResponse, Error<OrgQrError>> {
    let uri_str = format!(
        "{}/orgs/{id}/qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
) -> Result<models::QrResponse, Error<TableQrError>> {
    let uri_str = format!(
        "{}/branches/{id}/tables/{tid}/qr",
        configuration.base_path,
        id = crate::apis::urlencode(params.id),
        tid = crate::apis::urlencode(params.tid)
    );
