...
/// struct for passing parameters to the method [`get_org_modules`]
#[derive(Clone, Debug)]
pub struct GetOrgModulesParams {
    /// Organization ID
    pub id: String,
}
...
/// struct for typed errors of method [`get_org_modules`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetOrgModulesError {
    Status400(models::ErrorBody),
    Status401(models::ErrorBody),
    Status403(models::ErrorBody),
    Status404(models::ErrorBody),
...
) -> Result<models::OnboardingStatus, Error<CompleteOnboardingError>> {
    let uri_str = format!(
        "{}/orgs/{id}/onboarding/complete",
...
) -> Result<models::Org, Error<CreateOrgError>> {
...
) -> Result<models::OnboardingStatus, Error<GetOnboardingError>> {
    let uri_str = format!(
        "{}/orgs/{id}/onboarding",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn get_org_modules(
    configuration: &configuration::Configuration,
    params: GetOrgModulesParams,
) -> Result<models::OrgModules, Error<GetOrgModulesError>> {
    let uri_str = format!(
        "{}/orgs/{id}/modules",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::OrgModules`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::OrgModules`")))),
        }
    } else {
        let content = resp.text().await?;
        let entity: Option<GetOrgModulesError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent {
            status,
            content,
            entity,
...
pub async fn list_orgs(
    configuration: &configuration::Configuration,
) -> Result<Vec<models::Org>, Error<ListOrgsError>> {
    let uri_str = format!("{}/orgs", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
) -> Result<models::OfflineAuthBundle, Error<OfflineAuthBundleError>> {
    let uri_str = format!(
...
pub async fn public_org_brand(
    configuration: &configuration::Configuration,
    params: PublicOrgBrandParams,
) -> Result<models::PublicBrand, Error<PublicOrgBrandError>> {
...
pub async fn upload_org_card_image(
    configuration: &configuration::Configuration,
    params: UploadOrgCardImageParams,
) -> Result<models::Org, Error<UploadOrgCardImageError>> {
    let uri_str = format!(
        "{}/orgs/{id}/card-image",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
...
pub async fn upload_org_logo(
    configuration: &configuration::Configuration,
    params: UploadOrgLogoParams,
) -> Result<models::Org, Error<UploadOrgLogoError>> {
    let uri_str = format!(
        "{}/orgs/{id}/logo",
        configuration.base_path,
        id = crate::apis::urlencode(params.id)
