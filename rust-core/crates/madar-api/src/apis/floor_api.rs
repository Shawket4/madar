...
pub async fn clear_table(configuration: &configuration::Configuration, params: ClearTableParams) -> Result<(), Error<ClearTableError>> {

    let uri_str = format!("{}/floor/tables/{id}/clear", configuration.base_path, id=crate::apis::urlencode(params.id));
...
pub async fn swap_tables(configuration: &configuration::Configuration, params: SwapTablesParams) -> Result<(), Error<SwapTablesError>> {
