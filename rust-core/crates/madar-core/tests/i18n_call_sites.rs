...
const KNOWN_FAMILIES: &[&str] = &[
    "order", "cart", "charge", "checkout", "bill", "bills", "tables", "floor", "waiter", "ticket",
    "kds", "kitchen", "queue", "delivery", "history", "shift", "shifts", "till", "cash", "sync",
    "settings", "setup", "auth", "home", "chrome", "common", "err", "void", "drafts", "loyalty",
    "receipt", "search", "reservations", "booking", "bookings", "transfer", "sell", "print",
];
