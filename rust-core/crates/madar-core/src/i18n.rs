...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff_pool.subtitle" => "It rings at zero and still comes off the stock",
        ...
        "staff_pool.record" => "Record staff drink",
        "staff_pool.recorded" => "Staff drink recorded",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff_pool.subtitle" => "بيتسجل بصفر وبرضه بينزل من المخزن",
        ...
        "staff_pool.record" => "سجّل مشروب الموظفين",
        "staff_pool.recorded" => "اتسجل مشروب الموظفين",
