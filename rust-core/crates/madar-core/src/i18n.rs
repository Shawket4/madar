...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.err_already_decided" => "Someone already decided this. The list is up to date now.",
        "staff.err_employee_not_at_branch" => "They don't work at this branch, so a shift can't be set here for them.",
        "staff.err_flag_handled" => "Someone already handled this flag. The list is up to date now.",
        "staff.err_flag_cover_confirm_or_reject" => "A cover can only be confirmed or rejected.",
        ...
        "staff.err_reason_required_add" => "Say why you're adding this line.",
        "staff.err_reason_required_stop" => "Say why this monthly line stops.",
        "staff.err_reason_required_punch" => "Say why you're punching for them.",
        "staff.err_reason_required_expense" => "Say why you're changing this expense advance.",
        "staff.err_punch_in_future" => "That punch is dated in the future. Check the phone's clock.",
        ...
        "staff.mission_over_worked" => "{name} already clocked in on {dates}. Approving keeps those punches and pays the day as a mission, with no penalty.",
        "staff.leave_over_worked" => "{name} already clocked in on {dates}. Approving the leave keeps those punches.",
        ...
        "staff.n_claim_withdrawn" => "{name} took back their claim for the open shift on {date}",
        ...
        "staff.err_already_clocked_out" => "You were already clocked out, so this clock-out wasn't recorded.",
        "staff.err_not_clocked_in" => "You're not clocked in.",
        "staff.err_queued_period_closed" => "That month is already approved, so your offline punch wasn't recorded. Ask your manager.",
        "staff.err_queued_refused_in" => "Your offline clock-in was refused. Ask your manager to add it.",
        "staff.err_queued_refused_out" => "Your offline clock-out was refused. Ask your manager to add it.",
        "staff.err_queued_refused_cover" => "Your offline cover was refused. Ask your manager to add it.",
        "staff.err_queued_refused_punch" => "The punch you made offline for a colleague was refused.",
        ...
        "staff.err_shift_covered" => "{coverer_name} is covering this shift. A manager has to end or reject the cover first.",
        ...
        "staff.err_already_rostered_other" => "{name} is already on that shift.",
        "staff.err_suggestion_stale" => "That suggestion no longer applies — refresh.",
        "staff.err_already_claimed" => "Someone else claimed that shift first.",
        "staff.err_shift_started" => "That shift has already started — it can't be posted or claimed.",
        "staff.err_no_pending_claim" => "You have no claim waiting on this shift.",
        "staff.err_claim_already_decided" => "Your claim was already answered — ask your manager to change it.",
        "staff.err_swap_exists" => "You've already asked for this swap — it's waiting.",
        ...
        "staff.week_not_loaded" => "This week's roster couldn't be loaded, so nothing was changed. Pull down to refresh, then try again.",
        "staff.week_loading" => "Loading this week…",
        "staff.week_couldnt_load" => "This week couldn't be loaded. Pull down to try again.",
        "staff.week_needs_connection" => "This week isn't on your phone yet. Connect to the internet to see it.",
        "staff.open_shift_cant_move" => "An open shift can't be moved to another day. Cancel it, then post a new one on that day.",
        "staff.open_shift_gone" => "That open shift was taken back or claimed. Pull down to refresh.",
        "staff.open_shift_posted" => "Open shift posted",
        "staff.given_to" => "Given to {name}",
        ...
        "staff.coverage_saved" => "Coverage saved",
        ...
        "staff.day_6" => "Sat",
        "staff.day_7" => "Sun",
        // A weekday that recurs ("can't work on Fridays").
        "staff.weekdays_1" => "Mondays",
        "staff.weekdays_2" => "Tuesdays",
        "staff.weekdays_3" => "Wednesdays",
        "staff.weekdays_4" => "Thursdays",
        "staff.weekdays_5" => "Fridays",
        "staff.weekdays_6" => "Saturdays",
        "staff.weekdays_7" => "Sundays",
        "staff.month_1" => "Jan",
        "staff.month_2" => "Feb",
        "staff.month_3" => "Mar",
        "staff.month_4" => "Apr",
        ...
        "staff.good_afternoon" => "Good afternoon, {name}",
        "staff.good_evening" => "Good evening, {name}",
        "staff.expires_in" => "Expires in {time}",
        "staff.employee_evenings" => "Employee · evenings",
        "staff.privacy_pings" => "Your location is checked when you clock in or out, about every 15 minutes on shift, and when you leave your branch. Never after you clock out.",
        ...
        "staff.no_shifts_to_swap" => "No colleague has a shift you can swap with yet.",
        "staff.approved_mind" => "Approved. Mind: {warnings}.",
        "staff.swaps_waiting" => "Swaps waiting: {count}",
        "staff.swaps_to_answer" => "Waiting on your answer: {count}",
        "staff.swaps" => "Swaps",
        ...
        "staff.claimed_waiting_for_the_owner" => "Claimed — waiting for the owner",
        "staff.waiting_for_the_owner" => "Waiting for the owner",
        "staff.yours_waiting_for_the_owner" => "Yours, waiting for the owner",
        ...
        "staff.cover_not_confirmed" => "Not confirmed",
        "staff.cover_waiting" => "Waiting to be confirmed",
        ...
        "staff.outstanding_within_cap" => "Outstanding {amount} · within cap",
        "staff.outstanding_over_cap" => "Outstanding {amount} · over cap: only the owner can approve",
        ...
        "staff.said_they_can_t_work_s" => "{name} said they can't work on {day}.",
        ...
        "staff.nothing_to_pay" => "Nothing to pay",
        ...
        "staff.rule" => "Rule",
        "staff.rule_late" => "Rule · late",
        "staff.rule_absence" => "Rule · absence",
        "staff.rule_excuse" => "Rule · unpaid excuse",
        "staff.rule_flag" => "Rule · left mid-shift",
        ...
        "staff.line_deleted" => "Line deleted",
        "staff.only_rule_lines_waive" => "Only a deduction a rule made can be waived.",
        "staff.paid" => "Paid",
        "staff.people" => "People",
        ...
        "staff.stops_from_next_month" => "It stops from next month: this month's pay keeps it.",
        ...
        "staff.queued" => "Queued",
        "staff.refresh_offline" => "You're offline. Showing what the phone saved.",
        "staff.refresh_failed" => "Couldn't reach the server. Showing what the phone saved.",
        ...
        "staff.err_above_limit" => "That's above your limit. The owner can change it.",
        "staff.err_account_not_active" => "Your account isn't active. Ask your manager.",
        "staff.err_adjustment_kind_invalid" => "A pay line is a bonus or a deduction.",
        "staff.err_adjustment_not_found" => "That pay line isn't there any more. The list is up to date now.",
        "staff.err_advance_not_found" => "That advance isn't there any more. The list is up to date now.",
        "staff.err_already_decided_status" => "Someone already decided this: it was {status}. The list is up to date now.",
        "staff.err_already_employee" => "They're already on the team.",
        "staff.err_amount_not_positive" => "The amount must be more than zero.",
        "staff.err_amount_or_percent_required" => "Give an amount above zero, or a percentage from 1 to 100.",
        "staff.err_amount_required" => "Type the amount to deduct.",
        "staff.err_approve_with_generate" => "Approve the month from Payroll: approving freezes the payslips.",
        "staff.err_assignment_not_found" => "That shift isn't on the roster any more. The list is up to date now.",
        "staff.err_branch_not_found" => "That branch isn't there any more.",
        "staff.err_cancel_reason_required" => "Say why you're cancelling someone else's request.",
        "staff.err_cancel_reason_required_approved" => "Say why this approved request is cancelled.",
        "staff.err_clock_out_first" => "Clock out of your own shift first.",
        "staff.err_coordinates_out_of_range" => "Your phone sent a location that can't be right. Turn location off and on, then try again.",
        "staff.err_correction_applied" => "An approved correction already changed that punch. Correct the attendance record instead.",
        "staff.err_correction_waiting" => "A correction for this is already waiting.",
        "staff.err_date_in_future" => "The date can't be in the future.",
        "staff.err_day_off_no_times" => "A day off has no times.",
        "staff.err_day_of_week_invalid" => "That isn't a day of the week.",
        "staff.err_deduction_is_an_amount" => "A deduction is an amount, not a percentage.",
        "staff.err_early_departure_time_required" => "Say what time you expect to leave.",
        "staff.err_employee_not_found" => "That person isn't on the team any more.",
        "staff.err_employee_no_branch" => "That person has no branch yet.",
        "staff.err_employee_required" => "Pick the person first.",
        "staff.err_end_before_start" => "The end date is before the start date.",
        "staff.err_excuse_times_required" => "A permission needs a start and an end time.",
        "staff.err_expense_via_invalid" => "It's paid from the safe or the bank; a till pay-out is tagged on the till.",
        "staff.err_flag_action_unknown" => "That can't be done with this flag.",
        "staff.err_half_day_one_date" => "A half day starts and ends on the same date.",
        "staff.err_half_day_which_half" => "Say which half: the first or the second.",
        "staff.err_half_only_for_half_day" => "Only a half day says which half.",
        "staff.err_late_arrival_time_required" => "Say what time you expect to arrive.",
        "staff.err_manager_request_above" => "A manager's own request is decided by someone above them, usually the owner.",
        "staff.err_check_out_before_check_in" => "The clock-out must be after the clock-in.",
        "staff.err_correction_target_required" => "Pick the shift or the punch this corrects.",
        "staff.err_correction_time_required" => "Give the corrected time.",
        "staff.err_mission_title_required" => "Say where you'll be: a mission needs a note.",
        "staff.err_not_a_running_line" => "That isn't a running monthly line.",
        "staff.err_not_waived" => "That deduction isn't waived.",
        "staff.err_no_branch_yet" => "You have no branch yet. Ask your manager.",
        "staff.err_no_claim_waiting" => "No claim is waiting here any more. The list is up to date now.",
        "staff.err_no_cover_waiting" => "No cover is waiting here any more. The list is up to date now.",
        "staff.err_no_overtime_waiting" => "No overtime is waiting here any more. The list is up to date now.",
        "staff.err_no_swap_to_cancel" => "There's no swap of yours to cancel here any more. The list is up to date now.",
        "staff.err_no_swap_waiting" => "No swap is waiting here any more. The list is up to date now.",
        "staff.err_open_shift_closed" => "That shift was already filled or cancelled. The list is up to date now.",
        "staff.err_open_shift_closed_filled" => "That shift was already filled. The list is up to date now.",
        "staff.err_open_shift_closed_cancelled" => "That shift was already cancelled. The list is up to date now.",
        "staff.err_open_shift_not_found" => "That open shift isn't there any more. The list is up to date now.",
        "staff.err_otp_none_active" => "That code has expired. Send a new one.",
        "staff.err_otp_recently_sent" => "A code was just sent. Wait {wait_seconds} seconds before asking again.",
        "staff.err_override_not_found" => "That change isn't there any more. The list is up to date now.",
        "staff.err_own_advance" => "Someone else has to decide or record your own advance.",
        "staff.err_own_claim" => "You can't approve your own claim.",
        "staff.err_own_cover" => "You can't confirm a cover you're part of.",
        "staff.err_own_overtime" => "You can't approve your own overtime.",
        "staff.err_own_pay_line" => "You can't add or decide pay lines for yourself.",
        "staff.err_own_punch" => "Clock yourself in from your own phone.",
        "staff.err_own_request" => "Your own requests are decided by someone above you.",
        "staff.err_own_swap" => "You can't approve a swap you're part of.",
        "staff.err_paid_by_payslips" => "A month is paid once every payslip is marked paid.",
        "staff.err_payroll_not_approved" => "Approve the payroll before paying it.",
        "staff.err_payroll_paid_no_reopen" => "Someone has already been paid, so this payroll can't be reopened.",
        "staff.err_payslip_already_paid" => "That payslip is already paid. The list is up to date now.",
        "staff.err_pay_method_invalid" => "It's paid by cash, bank or wallet.",
        "staff.err_period_frozen" => "A month that's {status} is frozen. Reopen it first (only before anyone is paid).",
        "staff.err_period_not_draft_delete" => "A month that's {status} can't be deleted. Reopen it first (only before anyone is paid).",
        "staff.err_period_not_found" => "That payroll month isn't there any more. The list is up to date now.",
        "staff.err_period_not_generated" => "Approve the month before exporting it.",
        "staff.err_period_not_opened" => "The month couldn't be opened. Try again.",
        "staff.err_period_overlaps" => "Those dates overlap a payroll month that already exists.",
        "staff.err_period_status_move" => "A month that's {from} can't become {to}.",
        "staff.err_phone_taken" => "Someone here already signs in with {phone}.",
        "staff.err_pick_a_colleague" => "Pick a colleague.",
        "staff.err_pick_someone_else" => "Pick someone else.",
        "staff.err_preferences_invalid" => "Those preferences can't be saved. Check them and try again.",
        "staff.err_purpose_required" => "Say what it's for.",
        "staff.err_range_backwards" => "The end date is before the start date.",
        "staff.err_range_required" => "Pick a date range (from and to).",
        "staff.err_range_too_wide" => "That's too long: at most {max_days} days at a time.",
        "staff.err_record_exists" => "They already have a record for that day and shift. Correct it instead.",
        "staff.err_record_not_found" => "That attendance record isn't there any more. The list is up to date now.",
        "staff.err_record_other_date" => "That record isn't on the date you're correcting.",
        "staff.err_request_kind_unknown" => "This app doesn't know the request kind '{kind}'. Update the app.",
        "staff.err_request_not_found" => "That request isn't there any more. The list is up to date now.",
        "staff.err_rules_not_set" => "The owner hasn't saved the attendance rules yet. Ask the owner to finish set-up.",
        "staff.err_rule_line_not_deleted" => "A line the rules made is never deleted: waive or override it, with a reason.",
        "staff.err_setting_out_of_range" => "{field} must be between {min} and {max}.",
        "staff.err_setting_out_of_range_allowed" => "{field} must be one of: {allowed}.",
        "staff.err_shift_already_worked" => "They already worked that shift today.",
        "staff.err_shift_days_required" => "Pick at least one day for this shift.",
        "staff.err_shift_day_times_invalid" => "Each day can have its own times only once.",
        "staff.err_shift_day_times_off_day" => "{day} has its own times but isn't one of this shift's days.",
        "staff.err_shift_in_use" => "{name} is still on the roster ({n}). Move those first.",
        "staff.err_shift_name_required" => "Give the shift a name.",
        "staff.err_shift_not_coverable" => "That shift can't be covered.",
        "staff.err_shift_not_for_kind" => "Only a late arrival, early departure, permission or correction names a shift.",
        "staff.err_shift_not_found" => "That shift isn't there any more. The list is up to date now.",
        "staff.err_shift_not_started" => "That shift hasn't started yet.",
        "staff.err_shift_setting_invalid" => "{field} is out of range.",
        "staff.err_status_unknown" => "This app doesn't know the status '{status}'. Update the app.",
        "staff.err_times_both_or_neither" => "Give both a start and an end time, or neither.",
        "staff.err_waiver_final" => "That deduction was waived, and a waiver is final.",
        "staff.err_window_empty" => "The end time must be after the start time.",
        "staff.err_period_closed_punch" => "This month's payroll is closed, so this punch can't be recorded. Ask your manager.",
        "staff.err_refused_in" => "The server refused this clock-in. Ask your manager.",
        "staff.err_refused_out" => "The server refused this clock-out. Ask your manager.",
        "staff.err_refused_cover" => "The server refused this cover. Ask your manager.",
        "staff.err_refused_punch" => "The server refused this punch.",
        "staff.decided_approved" => "approved",
        "staff.decided_rejected" => "declined",
        "staff.decided_declined" => "declined",
        "staff.decided_cancelled" => "cancelled",
        "staff.decided_confirmed" => "confirmed",
        "staff.decided_settled" => "settled",
        "staff.period_draft" => "draft",
        "staff.period_generated" => "approved",
        "staff.period_paid" => "paid",
        "staff.period_closed" => "closed",
        "staff.setting_grace_minutes" => "Grace minutes",
        "staff.setting_break_minutes" => "Break minutes",
        "staff.setting_overtime_threshold_minutes" => "The overtime threshold",
        "staff.setting_checkin_window_minutes" => "The clock-in window",
        "staff.setting_half_day_threshold_minutes" => "The half-day threshold",
        "staff.setting_overtime_multiplier" => "The overtime rate",
        "staff.setting_ot_day_multiplier" => "The daytime overtime rate",
        "staff.setting_ot_night_multiplier" => "The night overtime rate",
        "staff.refresh_throttled" => "The server asked to slow down. Showing what the phone saved; try again in a moment.",
        ...
        "till.already_open" => "Your till was already open on this device, so no new till was opened.",
        ...
        "kitchen.recipe_heading" => "RECIPE",
        "kitchen.recipe" => "Recipe (for one):",
        "kitchen.steps" => "Steps:",
        "sell.send_recipe" => "Send recipe to kitchen",
        // A cart line's tools, labelled, when they take their own row.
        "sell.tool_staff" => "Staff",
        "sell.tool_kitchen" => "Kitchen",
        "sell.tool_recipe" => "Recipe",
        "printing.recipe_sent" => "Recipe sent to the kitchen",
        ...
        "order.items" => "items",
        "sell.back_to_menu" => "Back to menu",
        "sell.edit_line" => "Edit this item",
        "sell.back_to_categories" => "All categories",
        ...
        "settings.sell_layout" => "Sell layout",
        "settings.sell_layout_standard" => "Standard",
        "settings.sell_layout_fast" => "Fast mode",
        "settings.subtitle" => "How this till looks and behaves.",
        "settings.sell_layout_body" => "Where the cart sits and how an item's choices open. Prices, permissions and what gets sent are the same in both.",
        "settings.this_till_only" => "This till only",
        "settings.sell_layout_standard_desc" => "Menu first, cart at the end. Items with choices open in a sheet.",
        "settings.sell_layout_fast_desc" => "Cart first, menu at the end as category boxes. Choices, payment and notes open in place of the menu.",
        "settings.sell_layout_hint" => "Fast mode is on for this till. Tellers coming from other cashier systems usually find it familiar.",
        ...
        "order.add_failed" => "Couldn't add {item}. Try again.",
        "order.edit_failed" => "Couldn't open {item}. Try again.",
        "order.still_busy" => "One moment, the last tap is still going through.",
        ...
        "combo.pick_choose" => "Choose {group}",
        "combo.pick_choice_required" => "Choose {group} for {item}.",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.err_reason_required_add" => "قول ليه بتضيف البند ده.",
        "staff.err_reason_required_stop" => "قول ليه البند الشهري ده هيقف.",
        "staff.err_reason_required_punch" => "قول ليه بتسجّل بداله.",
        "staff.err_reason_required_expense" => "قول ليه بتغيّر سلفة المصاريف دي.",
        "staff.err_punch_in_future" => "التسجيل ده متسجّل بتاريخ لسه مجاش. راجع ساعة الموبايل.",
        ...
        "staff.mission_over_worked" => "{name} سجّل حضور فعلاً يوم {dates}. لو وافقت، البصمات دي هتفضل واليوم هيتحسب مأمورية من غير خصم.",
        "staff.leave_over_worked" => "{name} سجّل حضور فعلاً يوم {dates}. لو وافقت على الإجازة، البصمات دي هتفضل زي ما هي.",
        ...
        "staff.n_claim_withdrawn" => "{name} لغى حجزه للوردية المتاحة يوم {date}",
        ...
        "staff.err_already_clocked_out" => "إنت كنت مسجّل انصراف بالفعل، فالانصراف ده ما اتسجّلش.",
        "staff.err_not_clocked_in" => "إنت مش مسجّل حضور.",
        "staff.err_queued_period_closed" => "الشهر ده اتعتمد خلاص، فالتسجيل اللي عملته من غير نت ما اتسجّلش. كلّم مديرك.",
        "staff.err_queued_refused_in" => "الحضور اللي سجّلته من غير نت اترفض. اطلب من مديرك يضيفه.",
        "staff.err_queued_refused_out" => "الانصراف اللي سجّلته من غير نت اترفض. اطلب من مديرك يضيفه.",
        "staff.err_queued_refused_cover" => "التغطية اللي سجّلتها من غير نت اترفضت. اطلب من مديرك يضيفها.",
        "staff.err_queued_refused_punch" => "التسجيل اللي عملته لزميلك من غير نت اترفض.",
        ...
        "staff.err_shift_covered" => "{coverer_name} بيغطّي الوردية دي. لازم المدير ينهي التغطية أو يرفضها الأول.",
        ...
        "staff.err_already_rostered_other" => "{name} أصلاً على الوردية دي.",
        "staff.err_suggestion_stale" => "الاقتراح ده مبقاش ينفع — حدّث الصفحة.",
        "staff.err_already_claimed" => "حد تاني حجز الوردية دي قبلك.",
        "staff.err_shift_started" => "الوردية دي بدأت خلاص — مينفعش تتنشر أو تتحجز.",
        "staff.err_no_pending_claim" => "مفيش حجز ليك مستني على الوردية دي.",
        "staff.err_claim_already_decided" => "المدير رد على حجزك خلاص — اطلب منه يغيّره.",
        "staff.err_swap_exists" => "إنت طلبت التبديل ده قبل كده — لسه مستني الرد.",
        ...
        "staff.week_not_loaded" => "ماقدرناش نحمّل جدول الأسبوع ده، فمفيش حاجة اتغيرت. اسحب لتحت عشان تحدّث وجرّب تاني.",
        ...
        "staff.coverage_saved" => "العدد المطلوب اتحفظ",
        ...
        "staff.day_6" => "السبت",
        "staff.day_7" => "الأحد",
        "staff.weekdays_1" => "الإثنين",
        "staff.weekdays_2" => "الثلاثاء",
        "staff.weekdays_3" => "الأربعاء",
        "staff.weekdays_4" => "الخميس",
        "staff.weekdays_5" => "الجمعة",
        "staff.weekdays_6" => "السبت",
        "staff.weekdays_7" => "الأحد",
        "staff.month_1" => "يناير",
        ...
        "staff.good_afternoon" => "مساء الخير يا {name}",
        "staff.good_evening" => "مساء الخير يا {name}",
        "staff.expires_in" => "ينتهي بعد {time}",
        "staff.employee_evenings" => "موظف · مسائي",
        "staff.privacy_pings" => "موقعك بيتشاف وإنت بتسجل حضور أو انصراف، وكل 15 دقيقة تقريباً وإنت في الوردية، ولما تخرج من فرعك. وعمره ما بيتشاف بعد ما تسجل انصراف.",
        ...
        "staff.no_shifts_to_swap" => "مفيش زميل عنده وردية تقدر تبدّل بيها لسه.",
        "staff.approved_mind" => "اتوافق عليه. خد بالك: {warnings}.",
        "staff.swaps_waiting" => "تبديلات مستنية: {count}",
        "staff.swaps_to_answer" => "مستنية ردّك: {count}",
        "staff.swaps" => "التبديلات",
        ...
        "staff.claimed_waiting_for_the_owner" => "اتحجزت — مستنية صاحب الشغل",
        "staff.waiting_for_the_owner" => "مستني صاحب الشغل",
        "staff.yours_waiting_for_the_owner" => "طلباتك اللي مستنية صاحب الشغل",
        ...
        "staff.cover_not_confirmed" => "ما اتأكدتش",
        "staff.cover_waiting" => "مستنية التأكيد",
        ...
        "staff.outstanding_within_cap" => "عليه {amount} · جوّه الحد",
        "staff.outstanding_over_cap" => "عليه {amount} · فوق الحد: المالك بس يقدر يوافق",
        ...
        "staff.said_they_can_t_work_s" => "{name} قال مش هيقدر يشتغل أيام {day}.",
        ...
        "staff.nothing_to_pay" => "مفيش حاجة تتصرف",
        ...
        "staff.rule" => "قاعدة",
        "staff.rule_late" => "قاعدة · تأخير",
        "staff.rule_absence" => "قاعدة · غياب",
        "staff.rule_excuse" => "قاعدة · إذن من غير أجر",
        "staff.rule_flag" => "قاعدة · خرج أثناء الوردية",
        ...
        "staff.line_deleted" => "البند اتشال",
        "staff.only_rule_lines_waive" => "بس الخصم اللي عملته قاعدة هو اللي يتلغى.",
        "staff.paid" => "اتقبضت",
        ...
        "staff.stops_from_next_month" => "هيتوقف من الشهر الجاي: مرتب الشهر ده هيفضل فيه.",
        "staff.stopped_from_next_month" => "اتوقف من الشهر الجاي",
        ...
        "staff.queued" => "مستني",
        "staff.refresh_offline" => "إنت أوفلاين. ده آخر اللي اتحفظ على الموبايل.",
        ...
        "staff.err_account_not_active" => "حسابك مش متفعّل. كلّم مديرك.",
        "staff.err_adjustment_kind_invalid" => "البند يا مكافأة يا خصم.",
        "staff.err_adjustment_not_found" => "البند ده مبقاش موجود. القايمة اتحدّثت.",
        "staff.err_advance_not_found" => "السلفة دي مبقتش موجودة. القايمة اتحدّثت.",
        "staff.err_already_decided_status" => "حد تاني قرر في ده خلاص: {status}. القايمة اتحدّثت.",
        "staff.err_already_employee" => "الشخص ده موجود في الفريق أصلاً.",
        "staff.err_amount_not_positive" => "المبلغ لازم يكون أكتر من صفر.",
        "staff.err_amount_or_percent_required" => "اكتب مبلغ أكتر من صفر، أو نسبة من 1 لـ 100.",
        "staff.err_amount_required" => "اكتب المبلغ اللي هيتخصم.",
        "staff.err_approve_with_generate" => "اعتمد الشهر من المرتبات: الاعتماد بيثبّت قسايم المرتب.",
        "staff.err_assignment_not_found" => "الوردية دي مبقتش في الجدول. القايمة اتحدّثت.",
        "staff.err_branch_not_found" => "الفرع ده مبقاش موجود.",
        "staff.err_cancel_reason_required" => "قول ليه بتلغي طلب حد تاني.",
        "staff.err_cancel_reason_required_approved" => "قول ليه الطلب ده بيتلغي بعد ما اتوافق عليه.",
        "staff.err_clock_out_first" => "سجّل انصراف من ورديتك الأول.",
        "staff.err_coordinates_out_of_range" => "الموبايل بعت موقع مش مظبوط. اقفل الموقع وافتحه تاني وجرّب.",
        "staff.err_correction_applied" => "في تصحيح اتوافق عليه وغيّر التسجيل ده خلاص. عدّل سجل الحضور نفسه.",
        "staff.err_correction_waiting" => "في تصحيح لده مستني أصلاً.",
        "staff.err_date_in_future" => "التاريخ مينفعش يكون لسه مجاش.",
        "staff.err_day_off_no_times" => "يوم الراحة ملوش مواعيد.",
        "staff.err_day_of_week_invalid" => "ده مش يوم من أيام الأسبوع.",
        "staff.err_deduction_is_an_amount" => "الخصم بيبقى مبلغ، مش نسبة.",
        "staff.err_early_departure_time_required" => "قول هتمشي الساعة كام.",
        "staff.err_employee_not_found" => "الشخص ده مبقاش في الفريق.",
        "staff.err_employee_no_branch" => "الشخص ده لسه ملوش فرع.",
        "staff.err_employee_required" => "اختار الشخص الأول.",
        "staff.err_end_before_start" => "تاريخ النهاية قبل تاريخ البداية.",
        "staff.err_excuse_times_required" => "الإذن محتاج وقت بداية ووقت نهاية.",
        "staff.err_expense_via_invalid" => "بتتصرف من الخزنة أو البنك؛ الصرف من الكاشير بيتعلّم على الكاشير نفسه.",
        "staff.err_flag_action_unknown" => "ده مينفعش يتعمل مع التنبيه ده.",
        "staff.err_half_day_one_date" => "نص اليوم بيبدأ ويخلص في نفس اليوم.",
        "staff.err_half_day_which_half" => "قول أنهي نص: الأول ولا التاني.",
        "staff.err_half_only_for_half_day" => "نص اليوم بس هو اللي بيتقال فيه أنهي نص.",
        "staff.err_late_arrival_time_required" => "قول هتوصل الساعة كام.",
        "staff.err_manager_request_above" => "طلب المدير نفسه بيقرر فيه حد أعلى منه، غالباً صاحب الشغل.",
        "staff.err_check_out_before_check_in" => "الانصراف لازم يكون بعد الحضور.",
        "staff.err_correction_target_required" => "اختار الوردية أو التسجيل اللي بتصححه.",
        "staff.err_correction_time_required" => "اكتب الوقت الصح.",
        "staff.err_mission_title_required" => "قول هتبقى فين: المأمورية محتاجة ملاحظة.",
        "staff.err_not_a_running_line" => "ده مش بند شهري شغّال.",
        "staff.err_not_waived" => "الخصم ده مش متسامح فيه.",
        "staff.err_no_branch_yet" => "لسه مالكش فرع. كلّم مديرك.",
        "staff.err_no_claim_waiting" => "مفيش حجز مستني هنا خلاص. القايمة اتحدّثت.",
        "staff.err_no_cover_waiting" => "مفيش تغطية مستنية هنا خلاص. القايمة اتحدّثت.",
        "staff.err_no_overtime_waiting" => "مفيش أوفرتايم مستني هنا خلاص. القايمة اتحدّثت.",
        "staff.err_no_swap_to_cancel" => "مفيش تبديل بتاعك تلغيه هنا خلاص. القايمة اتحدّثت.",
        "staff.err_no_swap_waiting" => "مفيش تبديل مستني هنا خلاص. القايمة اتحدّثت.",
        "staff.err_open_shift_closed" => "الوردية دي اتملت أو اتلغت خلاص. القايمة اتحدّثت.",
        "staff.err_open_shift_closed_filled" => "الوردية دي اتملت خلاص. القايمة اتحدّثت.",
        "staff.err_open_shift_closed_cancelled" => "الوردية دي اتلغت خلاص. القايمة اتحدّثت.",
        "staff.err_open_shift_not_found" => "الوردية المفتوحة دي مبقتش موجودة. القايمة اتحدّثت.",
        "staff.err_otp_none_active" => "الكود ده خلص. ابعت كود جديد.",
        "staff.err_otp_recently_sent" => "لسه باعتين كود. استنى {wait_seconds} ثانية قبل ما تطلب تاني.",
        "staff.err_override_not_found" => "التغيير ده مبقاش موجود. القايمة اتحدّثت.",
        "staff.err_own_advance" => "سلفتك إنت لازم حد تاني هو اللي يقرر فيها أو يسجلها.",
        "staff.err_own_claim" => "مينفعش توافق على حجزك إنت.",
        "staff.err_own_cover" => "مينفعش تأكد تغطية إنت طرف فيها.",
        "staff.err_own_overtime" => "مينفعش توافق على الأوفرتايم بتاعك.",
        "staff.err_own_pay_line" => "مينفعش تضيف أو تقرر بنود لنفسك.",
        "staff.err_own_punch" => "سجّل حضورك من موبايلك إنت.",
        "staff.err_own_request" => "طلباتك إنت بيقرر فيها حد أعلى منك.",
        "staff.err_own_swap" => "مينفعش توافق على تبديل إنت طرف فيه.",
        "staff.err_paid_by_payslips" => "الشهر بيبقى مدفوع لما كل قسايم المرتب تتعلّم إنها اتدفعت.",
        "staff.err_payroll_not_approved" => "اعتمد المرتبات الأول قبل ما تدفعها.",
        "staff.err_payroll_paid_no_reopen" => "في حد اتدفعله خلاص، فالمرتبات دي مينفعش تتفتح تاني.",
        "staff.err_payslip_already_paid" => "القسيمة دي اتدفعت خلاص. القايمة اتحدّثت.",
        "staff.err_pay_method_invalid" => "الدفع يا كاش يا بنك يا محفظة.",
        "staff.err_period_frozen" => "الشهر ده {status} ومتثبّت. افتحه تاني الأول (قبل ما حد يتدفعله بس).",
        "staff.err_period_not_draft_delete" => "الشهر ده {status} ومينفعش يتمسح. افتحه تاني الأول (قبل ما حد يتدفعله بس).",
        "staff.err_period_not_found" => "شهر المرتبات ده مبقاش موجود. القايمة اتحدّثت.",
        "staff.err_period_not_generated" => "اعتمد الشهر الأول قبل ما تصدّره.",
        "staff.err_period_not_opened" => "الشهر ما اتفتحش. جرّب تاني.",
        "staff.err_period_overlaps" => "التواريخ دي داخلة في شهر مرتبات موجود أصلاً.",
        "staff.err_period_status_move" => "الشهر اللي {from} مينفعش يبقى {to}.",
        "staff.err_phone_taken" => "في حد هنا بيسجّل دخول بالرقم {phone} أصلاً.",
        "staff.err_pick_a_colleague" => "اختار زميل.",
        "staff.err_pick_someone_else" => "اختار حد تاني.",
        "staff.err_preferences_invalid" => "التفضيلات دي مينفعش تتحفظ. راجعها وجرّب تاني.",
        "staff.err_purpose_required" => "قول هي علشان إيه.",
        "staff.err_range_backwards" => "تاريخ النهاية قبل تاريخ البداية.",
        "staff.err_range_required" => "اختار فترة (من وإلى).",
        "staff.err_range_too_wide" => "الفترة طويلة: {max_days} يوم بالكتير كل مرة.",
        "staff.err_record_exists" => "في سجل ليه أصلاً لليوم والوردية دي. عدّله بدل ما تعمل جديد.",
        "staff.err_record_not_found" => "سجل الحضور ده مبقاش موجود. القايمة اتحدّثت.",
        "staff.err_record_other_date" => "السجل ده مش في اليوم اللي بتصححه.",
        "staff.err_request_kind_unknown" => "الأبلكيشن مش عارف نوع الطلب '{kind}'. حدّث الأبلكيشن.",
        "staff.err_request_not_found" => "الطلب ده مبقاش موجود. القايمة اتحدّثت.",
        "staff.err_rules_not_set" => "صاحب الشغل لسه ما حفظش قواعد الحضور. اطلب منه يكمّل الإعداد.",
        "staff.err_rule_line_not_deleted" => "البند اللي عملته القواعد مبيتمسحش: اتسامح فيه أو عدّله، مع ذكر السبب.",
        "staff.err_setting_out_of_range" => "{field} لازم يكون بين {min} و {max}.",
        "staff.err_setting_out_of_range_allowed" => "{field} لازم يكون واحد من: {allowed}.",
        "staff.err_shift_already_worked" => "الشخص ده اشتغل الوردية دي النهارده خلاص.",
        "staff.err_shift_days_required" => "اختار يوم واحد على الأقل للوردية دي.",
        "staff.err_shift_day_times_invalid" => "كل يوم ليه مواعيد خاصة مرة واحدة بس.",
        "staff.err_shift_day_times_off_day" => "{day} ليه مواعيد خاصة بس مش من أيام الوردية دي.",
        "staff.err_shift_in_use" => "{name} لسه في الجدول ({n}). انقلهم الأول.",
        "staff.err_shift_name_required" => "اكتب اسم للوردية.",
        "staff.err_shift_not_coverable" => "الوردية دي مينفعش تتغطى.",
        "staff.err_shift_not_for_kind" => "التأخير والانصراف بدري والإذن والتصحيح بس هم اللي بيتحدد فيهم وردية.",
        "staff.err_shift_not_found" => "الوردية دي مبقتش موجودة. القايمة اتحدّثت.",
        "staff.err_shift_not_started" => "الوردية دي لسه ما بدأتش.",
        "staff.err_shift_setting_invalid" => "{field} برّه الحدود المسموحة.",
        "staff.err_status_unknown" => "الأبلكيشن مش عارف الحالة '{status}'. حدّث الأبلكيشن.",
        "staff.err_times_both_or_neither" => "اكتب وقت البداية والنهاية الاتنين، أو ولا واحد فيهم.",
        "staff.err_waiver_final" => "الخصم ده اتسامح فيه، والتسامح نهائي.",
        "staff.err_window_empty" => "وقت النهاية لازم يكون بعد البداية.",
        "staff.err_period_closed_punch" => "مرتبات الشهر ده اتقفلت، فالتسجيل ده مينفعش يتسجّل. كلّم مديرك.",
        "staff.err_refused_in" => "السيرفر رفض تسجيل الحضور ده. كلّم مديرك.",
        "staff.err_refused_out" => "السيرفر رفض تسجيل الانصراف ده. كلّم مديرك.",
        "staff.err_refused_cover" => "السيرفر رفض التغطية دي. كلّم مديرك.",
        "staff.err_refused_punch" => "السيرفر رفض التسجيل ده.",
        "staff.decided_approved" => "اتوافق عليه",
        "staff.decided_rejected" => "اترفض",
        "staff.decided_declined" => "اترفض",
        "staff.decided_cancelled" => "اتلغى",
        "staff.decided_confirmed" => "اتأكد",
        "staff.decided_settled" => "اتسدد",
        "staff.period_draft" => "مسودة",
        "staff.period_generated" => "معتمد",
        "staff.period_paid" => "مدفوع",
        "staff.period_closed" => "مقفول",
        "staff.setting_grace_minutes" => "دقايق السماح",
        "staff.setting_break_minutes" => "دقايق البريك",
        "staff.setting_overtime_threshold_minutes" => "حد الأوفرتايم",
        "staff.setting_checkin_window_minutes" => "وقت فتح الحضور",
        "staff.setting_half_day_threshold_minutes" => "حد نص اليوم",
        "staff.setting_overtime_multiplier" => "سعر الأوفرتايم",
        "staff.setting_ot_day_multiplier" => "سعر أوفرتايم النهار",
        "staff.setting_ot_night_multiplier" => "سعر أوفرتايم الليل",
        "staff.refresh_throttled" => "السيرفر طلب نهدّي شوية. ده آخر اللي اتحفظ على الموبايل؛ جرّب تاني بعد شوية.",
        "staff.my_view" => "حسابي",
        ...
        "till.already_open" => "ورديتك كانت مفتوحة بالفعل على الجهاز ده، فمافيش وردية جديدة اتفتحت.",
        ...
        "kitchen.recipe_heading" => "الوصفة",
        "kitchen.recipe" => "الوصفة (للواحد):",
        "kitchen.steps" => "الخطوات:",
        "sell.send_recipe" => "إرسال الوصفة للمطبخ",
        "sell.tool_staff" => "موظفين",
        "sell.tool_kitchen" => "المطبخ",
        "sell.tool_recipe" => "الوصفة",
        "printing.recipe_sent" => "أُرسلت الوصفة إلى المطبخ",
        ...
        "order.items" => "أصناف",
        "sell.back_to_menu" => "العودة إلى القائمة",
        "sell.edit_line" => "تعديل هذا الصنف",
        "sell.back_to_categories" => "كل الأقسام",
        ...
        "settings.sell_layout" => "تخطيط شاشة البيع",
        "settings.sell_layout_standard" => "القياسي",
        "settings.sell_layout_fast" => "الوضع السريع",
        "settings.subtitle" => "شكل هذه الخزينة وطريقة عملها.",
        "settings.sell_layout_body" => "مكان السلة وطريقة فتح اختيارات الصنف. الأسعار والصلاحيات وما يُرسل واحد في الحالتين.",
        "settings.this_till_only" => "لهذه الخزينة فقط",
        "settings.sell_layout_standard_desc" => "القائمة أولاً والسلة في النهاية. اختيارات الصنف تفتح في لوحة منبثقة.",
        "settings.sell_layout_fast_desc" => "السلة أولاً والقائمة في النهاية كمربعات أقسام. الاختيارات والدفع والملاحظات تفتح مكان القائمة.",
        "settings.sell_layout_hint" => "الوضع السريع مفعّل لهذه الخزينة. غالباً ما يجده من اعتاد أنظمة كاشير أخرى مألوفاً.",
        ...
        "order.add_failed" => "تعذّرت إضافة {item}. حاول مرة أخرى.",
        "order.edit_failed" => "تعذّر فتح {item}. حاول مرة أخرى.",
        "order.still_busy" => "لحظة، ما زالت اللمسة السابقة قيد التنفيذ.",
        ...
        "combo.pick_choose" => "اختر {group}",
        "combo.pick_choice_required" => "اختر {group} لصنف {item}.",
