...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.inside_40_m_of_m" => "Inside {name} · 40 m of {radius} m",
        "staff.outside_340_m_away_limit_m" => "Outside {name} · 340 m away (limit {radius} m)",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.inside_40_m_of_m" => "جوه {name} · 40 م من {radius} م",
        "staff.outside_340_m_away_limit_m" => "برّه {name} · على بُعد 340 م (الحد {radius} م)",
