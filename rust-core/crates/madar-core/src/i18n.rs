...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "spot.needs_pin" => "Ask someone who can check the drawer to enter their PIN.",
        "spot.blind" => "The drawer figures stay hidden until the till is closed.",
        "spot.blind_count_note" => "Blind count",
        "spot.counted_cash" => "Counted cash",
        "spot.record" => "Record spot check",
        "spot.checks" => "Spot checks",
        "spot.tenders" => "Tenders by method",
        "spot.discrepancy" => "Difference",
        ...
        "spot.approved_by" => "Approved by",
        "spot.recorded" => "Spot check recorded",
        "spot.not_counted" => "Not counted",
        "spot.expected" => "Expected",
        "spot.counted" => "Counted",
        "spot.matches" => "Matches",
        "spot.over" => "Over",
        "spot.short" => "Short",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "spot.title" => "جرد مفاجئ",
        "spot.button" => "جرد مفاجئ",
        "spot.needs_pin" => "اطلب من شخص مخوّل بجرد الخزنة إدخال رقمه السري.",
        "spot.blind" => "أرقام الخزنة مخفية حتى إغلاق الوردية.",
        "spot.blind_count_note" => "عدّ دون رؤية المتوقع",
        "spot.counted_cash" => "النقد المعدود",
        "spot.record" => "تسجيل الجرد",
        "spot.checks" => "عمليات الجرد المفاجئ",
        "spot.tenders" => "المبالغ حسب طريقة الدفع",
        "spot.discrepancy" => "الفرق",
        "spot.show_figures" => "عرض الأرقام المتوقعة",
        "spot.blind_hint" => "عُدّ الخزنة وكل طريقة دفع. يظهر التقرير بعد الإغلاق.",
        "spot.approved_by" => "بموافقة",
        "spot.recorded" => "تم تسجيل الجرد",
        "spot.not_counted" => "لم يُعدّ",
        "spot.expected" => "المتوقع",
        "spot.counted" => "المعدود",
        "spot.matches" => "مطابق",
        "spot.over" => "زيادة",
        "spot.short" => "عجز",
