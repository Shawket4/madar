...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "settings.sell_layout_legacy" => "Legacy",
        "settings.sell_layout_hint" => "Legacy puts the cart first and opens an item's choices, the charge and notes where the menu was. Tablets only.",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "settings.sell_layout_legacy" => "الكلاسيكي",
        "settings.sell_layout_hint" => "الكلاسيكي يضع السلة أولاً ويفتح اختيارات الصنف والتحصيل والملاحظات مكان القائمة. للأجهزة اللوحية فقط.",
