...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "till.z_held_left_open" => "طلبات معلّقة تُركت مفتوحة",
        "till.held_open_title" => "لا تزال {count} من الطلبات المعلّقة مفتوحة",
        "till.held_open_body" => "ستبقى معلّقة للوردية التالية. ارجع لتسويتها أو حذفها، أو أغلق على أي حال.",
        "till.held_open_back" => "رجوع",
        "till.held_open_continue" => "أغلق على أي حال",
        ...
        "metrics.title" => "المؤشرات",
        "metrics.preset.today" => "اليوم",
        "metrics.preset.yesterday" => "أمس",
        "metrics.preset.this_week" => "هذا الأسبوع",
        "metrics.preset.this_month" => "هذا الشهر",
        "metrics.preset.last_7_days" => "آخر 7 أيام",
        "metrics.preset.custom" => "فترة مخصصة",
        "metrics.custom_from" => "اليوم الأول",
        "metrics.custom_to" => "اليوم الأخير",
        "metrics.net_sales" => "صافي المبيعات",
        "metrics.gross_sales" => "المبيعات قبل المرتجعات",
        "metrics.refunded" => "المسترد من هذه المبيعات",
        "metrics.orders" => "الطلبات",
        "metrics.average_ticket" => "متوسط الفاتورة",
        "metrics.tenders" => "المدفوعات حسب الطريقة",
        "metrics.refunds_voids" => "المرتجعات والإلغاءات",
        "metrics.voided" => "مبيعات ملغاة",
        "metrics.refunded_in_full" => "مبيعات مستردة بالكامل",
        "metrics.refunds_issued" => "مرتجعات صادرة",
        "metrics.top_items" => "الأصناف الأكثر مبيعًا",
        "metrics.hourly" => "المبيعات حسب الساعة",
        "metrics.count" => "العدد",
        "metrics.empty" => "لا توجد مبيعات في هذه الفترة.",
        "metrics.error" => "تعذر تحميل المؤشرات.",
        "metrics.retry" => "حاول مرة أخرى",
        "metrics.show" => "عرض",
        "metrics.offline_note" => "غير متصل: عرض آخر {days} أيام يحتفظ بها هذا الجهاز منذ {since}",
        "metrics.offline_nothing_held" => "غير متصل: لا يحتفظ هذا الجهاز بسجل مبيعات بعد",
        "metrics.items_missing" => "الأصناف الأكثر مبيعًا لا تشمل {count} من المبيعات غير المتزامنة بعد",
        ...
        "spot.title" => "الجرد المفاجئ",
        "spot.button" => "الجرد المفاجئ",
        "spot.needs_pin" => "اطلب من شخص مخوّل برؤية أرقام الخزنة إدخال رقمه السري.",
        "spot.blind" => "أرقام الخزنة مخفية حتى إغلاق الوردية.",
        "spot.blind_count_note" => "عدّ دون رؤية المتوقع",
        "spot.views" => "مرات عرض تقرير الجرد المفاجئ",
        "spot.printed" => "مطبوع",
        "spot.print" => "طباعة تقرير الجرد المفاجئ",
        "spot.approved_by" => "بفتح من",
        "spot.show_figures" => "عرض الأرقام المتوقعة",
        "spot.blind_hint" => "عُدّ الخزنة وكل طريقة دفع. يظهر التقرير بعد الإغلاق.",
        ...
        "history.void_stock" => "تعود الأصناف إلى المخزون.",
        "history.refund_items" => "الأصناف المستردة",
        "history.refund_items_hint" => "الأصناف المستردة قُدِّمت بالفعل، لذا تُحتسب هالكًا. لا تختر شيئًا إذا كان الاسترداد مبلغًا فقط.",
        ...
        "sync.op_record_waste" => "هالك",
        "waste.title" => "تسجيل الهالك",
        "waste.subtitle" => "خصم المخزون التالف أو المسكوب",
        ...
        "waste.takes" => "يُخصم من المخزون",
        "waste.value" => "القيمة",
        "waste.value_partial" => "بعض المكونات بلا تكلفة",
        "waste.record" => "تسجيل الهالك",
        "waste.recorded" => "تم تسجيل الهالك",
        "waste.empty" => "لا توجد نتائج",
        "waste.pick_something" => "اختر صنفًا أو مكوّنًا",
        "waste.qty_required" => "أدخل كمية أكبر من صفر",
        "waste.whole_units" => "يُسجَّل هالك الصنف بوحدات كاملة",
        "waste.unit_mismatch" => "هذه الوحدة لا تناسب هذا المكوّن",
        "waste.no_recipe" => "لا توجد وصفة لهذا الصنف؛ سجّل هالك مكوناته",
        "waste.reason_required" => "اختر السبب",
        "waste.reason_expired" => "منتهي الصلاحية",
        "waste.reason_spoiled" => "تالف",
        "waste.reason_damaged" => "مكسور أو متضرر",
        "waste.reason_overproduction" => "إنتاج زائد",
        ...
        "discount.none_allowed" => "لا يمكنك منح خصومات على نقطة البيع هذه.",
