...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "err.no_shift" => "Open a shift first.",
        ...
        "err.shift_for_stranded" => "Open a shift first so the waiting orders can move onto it.",
        ...
        "shifts.length" => "Length",
        "shifts.balanced" => "Balanced",
        "shifts.short" => "Short",
        "shifts.over" => "Over",
        "shifts.empty_message" => "Every shift this branch opens and closes appears here.",
        "shift.payment_methods" => "Payment methods",
        "shift.orders_col" => "Orders",
        "cash.note_col" => "For",
        "cash.amount_col" => "Amount",
        "shift.drawer" => "Drawer",
        "shift.show_orders" => "Show orders",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "err.force_close_reason" => "اذكر سبب إغلاق درج شخص آخر.",
        // ── the redesign (2026-09-12): three shells, one Charge, a Bill that is a screen ──
        // shells (apps/madar): tab words and the outbox pill
        "nav.sell" => "البيع",
        "nav.floor" => "الصالة",
        ...
        "shifts.length" => "المدة",
        "shifts.balanced" => "مطابقة",
        "shifts.short" => "عجز",
        "shifts.over" => "زيادة",
        "shifts.empty_message" => "تظهر هنا كل وردية تُفتح وتُغلق في هذا الفرع.",
        "shift.payment_methods" => "طرق الدفع",
        "shift.orders_col" => "الطلبات",
        "cash.note_col" => "البيان",
        "cash.amount_col" => "المبلغ",
        "shift.drawer" => "الدرج",
        "shift.show_orders" => "عرض الطلبات",
