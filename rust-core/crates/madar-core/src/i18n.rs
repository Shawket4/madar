...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "tables.seat_here" => "Seat current order here",
        ...
        "tables.settings" => "Table settings",
        ...
        "tables.settle_first" => "Settle or move the ticket first",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "tables.seat_here" => "إجلاس الطلب الحالي هنا",
        ...
        "tables.settings" => "إعدادات الطاولة",
