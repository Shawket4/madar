...
fn en(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.warn_week_hours" => "Over {hours} h this week",
        "staff.warn_rest" => "Under 12 h rest before {date}",
...
fn ar(key: &str) -> Option<&'static str> {
    Some(match key {
        ...
        "staff.warn_week_hours" => "أكتر من {hours} ساعة في الأسبوع",
        "staff.warn_rest" => "راحة أقل من 12 ساعة قبل {date}",
