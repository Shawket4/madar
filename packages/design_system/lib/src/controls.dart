...
class MadarButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final tip = tooltip;
    if (tip != null) {
      // Hold to read: a glyph-only button says its word on a long press —
      // unless the long press is already its preview.
      button = Tooltip(
        message: tip,
        triggerMode: onLongPress == null ? TooltipTriggerMode.longPress : null,
        child: button,
      );
    }
