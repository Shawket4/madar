  ...
  Widget build(BuildContext context) {
    ...
    final tools = Wrap(
      ...
      children: [
        ...
        // for its kitchen note, a preview, and print. That long press is the
        // tile's own, so its word (the semantic label) shows on a resting
        // mouse only; the sheet it opens is titled with the item's name.
        MadarGlyphTile(
        ...
        // printer as this dish's chit. Only on an item that has either. A
        // long press says so (the tile's own hold hint).
