...
#   MADAR_OB_TEST         the ignored integration test to run (default offline_b_backend;
...
echo "==> scenarios"
cargo test -p madar-core --test "${MADAR_OB_TEST:-offline_b_backend}" -- --ignored --nocapture --test-threads=1
