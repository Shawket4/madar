...
/// Static UI strings, loaded from bundled JSON at boot. The dashboard owns its
/// own chrome copy (the plan's i18n split); the core still localizes dynamic /
/// domain content. Lookups fall back en → key so a missing key is never fatal.
class Strings {
